...
#pragma config(Motor,  port1,           rightClaw,     tmotorNone, openLoop)
...
#pragma config(Motor,  port5,           leftMidLift,   tmotorVex393_MC29, openLoop, driveLeft)
#pragma config(Motor,  port6,           rightMidLift,  tmotorVex393_MC29, openLoop, driveRight)
#pragma config(Motor,  port7,           rightLift,     tmotorVex393_MC29, openLoop, driveRight)
#pragma config(Motor,  port8,           leftClaw,      tmotorVex393_MC29, openLoop, driveLeft)
...
void
setLDriveBase( int valueR, int time )
{
...
task usercontrol()
{
	while (true)
	{
		setLDriveBase(abs(vexRT[ Ch3 ]) > 25 ? vexRT[ Ch3 ] : 0); //mess with deadbands
		setRDriveBase(abs(vexRT[ Ch2 ]) > 25 ? vexRT[ Ch2 ] : 0);
		...
		*/
		...
		setLift((vexRT[ Btn6D ] - vexRT[ Btn5D ]) * -127);
